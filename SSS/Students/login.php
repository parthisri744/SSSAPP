...
if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
    header("location: index.php?temp=.md5(dashboard)");
    exit;
}
...
<body">
    <div><?php  require_once("../Navigation/stuLoginnav.php");  ?></div>
    <?php 
	if($submit) {
	if(strlen($result)>0){  ?>
    ...
    <div class="card shadow p-3">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="needs-validation" novalidate>
            ...
            <span class="invalid-feedback">Please Enter Register Number</span>
            </div>    
            <div class="form-group">
